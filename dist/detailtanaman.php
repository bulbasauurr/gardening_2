...
<div class="lg:p-80 lg:pb-10 lg:pt-10 pb-10 pt-10">
  ...
  <div class="text-center mb-5">
      <h1 class="text-lg text-center text-green-800 md:text-3xl font-bold mb-2">Pupuk yang Cocok  </h1>
    </div>
    ...
    <div class="container my-4 mx-auto md:px-10 justify-center">
      <div class="flex flex-wrap -mx-1 lg:-mx-4 justify-center">
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
            <!-- Article -->
            <article class="overflow-hidden rounded-lg shadow-lg border-green-600 border-opacity-50 border-2 border-solid">
                    <img class="object-cover md:object-cover h-60 w-full" src="https://s3.bukalapak.com/img/3176876926/s-330-330/85468918_b322fb7e_ef05_4b83_bef1_45aee7889c82.jpg.webp">
                <header class="flex h-16 bg-green-800 items-center justify-between leading-tight p-2 md:p-4">
                <a href="detailpupuk.php">    
                <h1 class="text-base md:text-base text-white text-center font-bold">Pupuk Hijau</h1>
                  </header>
            </article>
          </div>
